...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo $ROOT;?>/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    <link rel="stylesheet" href="<?php echo $ROOT;?>/plugins/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php echo $ROOT;?>/plugins/daterangepicker/daterangepicker.css">
    <!-- summernote -->
    <link rel="stylesheet" href="<?php echo $ROOT;?>/plugins/summernote/summernote-bs4.css">
